...
const String serviceTypeDiscover = '_ewelink._tcp';
const String serviceTypeRegister = '_ewelink._tcp';
const utf8encoder = Utf8Encoder();

class SetupDeviceView extends StatefulWidget{
  const SetupDeviceView({Key? key}) : super(key: key);

  @override
  State createState() => SetupDeviceViewState();
}

class SetupDeviceViewState extends State<SetupDeviceView> {
